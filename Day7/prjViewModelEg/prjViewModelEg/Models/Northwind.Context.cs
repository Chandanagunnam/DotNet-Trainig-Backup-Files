...
namespace prjViewModelEg.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<proc_DeleteProduct_Result> proc_DeleteProduct(Nullable<int> pID)
        {
            var pIDParameter = pID.HasValue ?
                new ObjectParameter("PID", pID) :
                new ObjectParameter("PID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<proc_DeleteProduct_Result>("proc_DeleteProduct", pIDParameter);
        }
    
        public virtual ObjectResult<proc_maxorderbycustomer_Result> proc_maxorderbycustomer()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<proc_maxorderbycustomer_Result>("proc_maxorderbycustomer");
        }
    
        public virtual ObjectResult<proc_OutOfStockProducts_Result> proc_OutOfStockProducts()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<proc_OutOfStockProducts_Result>("proc_OutOfStockProducts");
        }
        ...
        public System.Data.Entity.DbSet<prjViewModelEg.ViewModel.ProductVM> ProductVMs { get; set; }
    }
}
